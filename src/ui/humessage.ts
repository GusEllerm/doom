...
export const HU_WRITE_SITES: readonly HuWriteSite[] = [
  ...
  { file: 'src/sim/pplayer.ts', line: 308, writes: "'' (clear)", origin: "P_SpawnPlayerFromStart — port-side clear (vanilla P_SpawnPlayer writes no message; the spawn-time wipe mirrors g_game.c:816's memset clearing message)" },
  { file: 'src/sim/pplayer.ts', line: 365, writes: "'' (clear)", origin: 'G_PlayerReborn (g_game.c:800-831, the memset clears player->message)' },
