...
| M4-05 | Static sprite pass (R_AddSprites/DrawVisSprite) | M4 | M4-03 | dispatched (agent b7a33f5c) |
| M4-06 | Fixture extension (sky/fences/things/panning) | M4 | M4-01..03 | dispatched (agent 709010ad) |
